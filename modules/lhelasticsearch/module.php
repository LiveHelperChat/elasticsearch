...
$ViewList['interactions'] = array(
    'params' => array(),
    'uparams' => array('fuzzy','search_in','attr','val','timefrom','timefrom_minutes','timefrom_hours','timeto','timeto_minutes','timeto_hours','sort_chat','keyword'),
...
$ViewList['listmail'] = array(
    ...
    'uparams' => array(
        ...
        'phone','opened','search_email_in','timefromts','fuzzy'
    ),
    'multiple_arguments' => array(
        'search_in',
        'department_ids',
