...
$ViewList['listmail'] = array(
    ...
    'uparams' => array(
        ...
        'status_msg_id','mailbox_ids','expression'
    ),
    'multiple_arguments' => array(
        'search_in',
        'department_ids',
