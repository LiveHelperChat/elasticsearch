            ...
            <div class="input-group input-group-sm">
                ...
                <div class="input-group-append ">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <label class="dropdown-item mb-0 pl-2"><input type="radio" <?php if ($input->fuzzy_prefix == 1) : ?>checked="checked"<?php endif;?> name="fuzzy_prefix" value="1" /> Length of the keyword minus 1 character's</label>
                        <label class="dropdown-item mb-0 pl-2"><input type="radio" <?php if ($input->fuzzy_prefix == 2) : ?>checked="checked"<?php endif;?> name="fuzzy_prefix" value="2" /> Length of the keyword minus 2 character's (default)</label>
