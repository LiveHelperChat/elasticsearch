            ...
            <div class="input-group input-group-sm">
                <input type="text" placeholder="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('bracket/lists/filter','Keyword messages');?>" class="form-control form-control-sm" name="keyword" id="keyword-field" value="<?php echo htmlspecialchars($input->keyword)?>" />
                    ...
                    <div class="dropdown-menu">
                        ...
                        <label class="dropdown-item mb-0 ps-2"><input type="checkbox" <?php if (is_array($input->search_in) && in_array(5,$input->search_in)) : ?>checked="checked"<?php endif;?> name="search_in[]" value="5" /> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/lists/search_panel','Bot messages');?></label>
                        <div role="separator" class="dropdown-divider"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <select class="form-control form-control-sm" name="wait_time_from">
                                                ...
                                                <option value="15" <?php $input->wait_time_from === 15 ? print 'selected="selected"' : ''?>>15 seconds</option>
                                        ...
                                        <div class="col-6">
                                            <select class="form-control form-control-sm" name="wait_time_till">
                                                ...
                                                <option value="15" <?php $input->wait_time_till === 15 ? print 'selected="selected"' : ''?>>15 seconds</option>
