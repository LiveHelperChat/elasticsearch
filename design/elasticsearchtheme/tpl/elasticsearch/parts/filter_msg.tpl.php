...
<form action="<?php echo erLhcoreClassDesign::baseurl('elasticsearch/list')?>/(tab)/messages#/messages" autocomplete="off" method="get" name="SearchFormRight" ng-non-bindable>
